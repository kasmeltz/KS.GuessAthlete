        ...
        private const string _updateSql = @"
	        ...
	        BEGIN
                ...
                SET
                    ...
                    Assists = @Wins,
                    PlusMinus = @Losses,
                    PenaltyMinutes = @TiesPlusOvertimeShootoutLosses,
                    EvenStrengthGoals = @GoalsAgainst,
                    PowerPlayGoals = @ShotsAgainst,
                    ShortHandedGoals = @Saves,
                    GameWinningGoals = @SavePercentage,
                    EvenStrengthAssists = @GoalsAgainstAverage,
                    PowerPlayAssists = @Shutouts,
                    ShortHandedAssists = @Minutes,
                    Shots = @QualityStarts,
                    ShotPercentage = @QualityStartPercentage,
                    TimeOnIce = @ReallyBadStarts,
                    AverageTimeOnIce = @GoalsAgainstPercentage,
